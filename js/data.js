...
const METRICS = {
  voterTurnout: {
    ...
    colorScale: ["#1a3a5c", "#1e6bb8", "#4fc3f7", "#e3f2fd"],
  ...
  proHealthVotes: {
    key: "proHealthVotes",
    label: "Pro-Health Votes",
    unit: "%",
    format: v => `${(v * 100).toFixed(1)}%`,
    colorScale: ["#1b3a1f", "#2e7d32", "#66bb6a", "#e8f5e9"],
  ...
  leadLevel: {
    key: "leadLevel",
    label: "Lead Contamination",
    unit: "ppb",
    format: v => `${v.toFixed(1)} ppb`,
    colorScale: ["#fff9c4", "#ffb74d", "#ef5350", "#7f0000"],
  ...
  schoolScore: {
    ...
    unit: "/100",
    format: v => `${v}/100`,
    colorScale: ["#4a0072", "#7b1fa2", "#ba68c8", "#f3e5f5"],
    thresholds: [40, 55, 65, 75, 90],
    colors: ["#4a0072", "#7b1fa2", "#9c27b0", "#ce93d8", "#f3e5f5"],
    icon: "📚",
    description: "Composite school performance index combining standardized test scores and 4-year graduation rates, normalized to 100.",
  },
};
